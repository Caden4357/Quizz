...
function App() {
  ...
  return (
    <div>
      <Nav/>
      <Routes>
        <Route path='/' element={<Homepage beginQuiz={beginQuiz} questions={questions} setScore={setScore} score={score} currentQuestion={currentQuestion} setCurrentQuestion={setCurrentQuestion} />} />
